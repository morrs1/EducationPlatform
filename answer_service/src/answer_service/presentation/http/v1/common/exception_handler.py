...
def setup_exception_handlers(app: FastAPI) -> None:
    status_map: Final[dict[type[Exception], int]] = {
    ...
    async def application_error_handler(  # noqa: RUF029
    ...
    async def domain_error_handler(  # noqa: RUF029
        _: Request, exc: DomainError
    ) -> JSONResponse:
        return JSONResponse(
