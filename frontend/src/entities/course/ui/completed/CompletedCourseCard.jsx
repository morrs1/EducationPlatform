...
function CompletedCourseCard() {
  ...
  return (
    <article className="completed-course-card">
      <div className="completed-course-menu-wrap" ref={menuRef}>
        <button
          type="button"
      ...
      <div className="completed-course-card-content">
        ...
        <div className="completed-course-card-body">
          <div className="completed-course-card-meta">
            ...
            >
              Некий завершенный курс
            </Link>

            <Link
              className="completed-course-card-author"
          ...
          <div className="completed-course-progress">
            ...
            <div className="completed-course-progress-row">
              ...
              <button type="button" className="completed-course-review-btn">
                Оставить отзыв
              </button>
            </div>
          </div>
