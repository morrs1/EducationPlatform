...
function CurrentCourseCard() {
  ...
  return (
    <article className="current-course-card">
      <div className="current-course-menu-wrap" ref={menuRef}>
        <button
          type="button"
      ...
      <div className="current-course-card-content">
        ...
        <div className="current-course-card-body">
          <div className="current-course-card-meta">
            ...
            <Link
              className="current-course-card-author"
          ...
          <div className="current-course-progress">
            ...
            <div className="current-course-progress-row">
              ...
              <button type="button" className="current-course-review-btn">
                Оставить отзыв
              </button>
            </div>
          </div>
